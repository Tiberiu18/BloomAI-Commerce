...
const ProfileScreen = () => {
  ...
  const myOrderListState = useSelector((state) => state.orderList);
  const { loading, error, orders } = myOrderListState;
              ...
              <div className="author-card-profile row">
                ...
                <div className="author-card-details col-md-7">
                  ...
                  <span className="author-card-position">
                    <>Membru din {moment(userInfo.createdAt).format("DD/MM/YYYY")}</>
                  </span>
                </div>
              </div>
            </div>
