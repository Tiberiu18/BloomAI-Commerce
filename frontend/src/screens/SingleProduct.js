      ...
      <div className="container single-product">
              ...
              <div className="product-count col-lg-7 ">
                ...
                {product.countInStock > 0 ? (
                  <>
                    ...
                    <button onClick={AddToCartHandle} className="round-black-btn">Adaugă în coș</button>
                  </>
                ) : null}
              </div>
            </div>
        ...
        <div className="row my-5">
          <div className="col-md-6">
            ...
            {
              product.reviews.length === 0 && <Message variant={"alert-info mt-3"}>Nicio recenzie</Message>
            }
            {
              ...
              userInfo ? (
                ...
                <div className="my-4">
                  ...
                  <select value={rating} onChange= {(e)=> setRating(e.target.value)} className="col-12 bg-light p-3 mt-2 border-0 rounded">
                    ...
                    <option value="2">Două stele</option>
                    <option value="3">Trei stele</option>
                    <option value="4">Patru stele</option>
                    <option value="5">Cinci stele</option>
                  </select>
                </div>
                <div className="my-4">
                ...
                <Message variant={"alert-warning"}>
                  Vă rog să vă {" "}
                  <Link to="/login">
                     <strong>logați</strong> 
                  </Link>{" "}
                  pentru a scrie un review{" "}
                </Message>
              </div>
            }
