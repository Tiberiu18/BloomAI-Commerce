...
// register
export const register = (name, email,password, sex, ageGroup, favoriteColors, favoriteFlowers) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`/api/users`, {name, email, password, sex, ageGroup, favoriteColors, favoriteFlowers}, config);
